          ...
          <div className="flex-1 text-center lg:text-left space-y-8 animate-fade-in">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight">
                ...
                with <span className="text-transparent bg-clip-text bg-gradient-primary">Lead</span>
                <span className="text-foreground">Caller</span>
                <span className="text-accent"> AI</span>
              </h1>
              
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                LeadCaller AI is an AI-powered call bot that uses Bland AI to make smart, human‑like cold calls for your property business – qualifying leads and booking meetings while you focus on closing deals.
              </p>
            </div>
