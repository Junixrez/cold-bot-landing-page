...
const steps = [
  {
    ...
    description: "Import your contact list from CSV, CRM, or spreadsheets. Cold Bot integrates with your existing tools seamlessly."
  },
  {
    icon: Phone,
    step: "Step 2",
  ...
  },
  {
    ...
    description: "All qualified leads with budget, location, and timeline details sent to your CRM or email automatically."
  }
];
